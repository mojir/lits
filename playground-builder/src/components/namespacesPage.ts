...
const namespaceInfo: NamespaceInfo[] = [
  {
    ...
    examples: [
      'let vec = import("vec"); vec.sum([1, 2, 3, 4, 5])',
      'let vec = import("vec"); vec.mean([1, 2, 3, 4, 5])',
      'let vec = import("vec"); vec.stdev([1, 2, 3, 4, 5])',
    ],
  },
  {
    name: 'Linear Algebra',
    ...
    examples: [
      'let lin = import("lin"); lin.dot([1, 2, 3], [4, 5, 6])',
      'let lin = import("lin"); lin.cross([1, 0, 0], [0, 1, 0])',
      'let lin = import("lin"); lin.norm([3, 4])',
    ],
  },
  {
    name: 'Matrix',
    ...
    examples: [
      'let mat = import("mat"); mat.identity(3)',
      'let mat = import("mat"); mat.transpose([[1, 2], [3, 4]])',
      'let mat = import("mat"); mat.det([[1, 2], [3, 4]])',
    ],
  },
  {
    name: 'Grid',
  ...
  },
  {
    ...
    examples: [
      'let nt = import("nth"); nt.prime?(17)',
      'let nt = import("nth"); nt.fibonacci-seq(10)',
      'let nt = import("nth"); nt.factorial(5)',
    ],
  },
  {
    name: 'Random',
    ...
    examples: [
      'let rand = import("rand"); rand.random()',
      'let rand = import("rand"); rand.random-integer(100)',
      'let rand = import("rand"); rand.shuffle([1, 2, 3, 4, 5])',
    ],
  },
]
