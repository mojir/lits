module.exports = {
  ...
  'string>': {
    ...
    description: `Compares the two string arguments lexicographically, and the result is \`true\` if \`string1\` is greater than \`string2\`, otherwise result is \`false\`.`,
    examples: [
  ...
  'string>=': {
    ...
    description: `Compares the two string arguments lexicographically, and the result is \`true\` if \`string1\` is greater than or equal to \`string2\`, otherwise result is \`false\`.`,
    examples: [
      `(string>= "A string" "Another string")`,
      `(string>= "Albert Mojir" "Albert")`,
      `(string>= "Albert" "Albert")`,
  ...
  'string<': {
    ...
    description: `Compares the two string arguments lexicographically, and the result is \`true\` if \`string1\` is less than \`string2\`, otherwise result is \`false\`.`,
    examples: [
      `(string< "A string" "Another string")`,
      `(string< "Albert Mojir" "Albert")`,
      `(string< "Albert" "Albert")`,
  ...
  'string<=': {
    ...
    description: `Compares the two string arguments lexicographically, and the result is \`true\` if \`string1\` is less than or equal to \`string2\`, otherwise result is \`false\`.`,
    examples: [
      `(string<= "A string" "Another string")`,
      `(string<= "Albert Mojir" "Albert")`,
      `(string<= "Albert" "Albert")`,
