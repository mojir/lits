module.exports = {
  ...
  'string>': {
    ...
    shortDescription: `Compares the two string arguments lexicographically, and the result is \`true\` if \`string1\` is greater than \`string2\`, otherwise result is \`false\`.`,
    longDescription: `Compares the two string arguments lexicographically, and the result is \`true\` if \`string1\` is greater than \`string2\`, otherwise result is \`false\`.`,
    examples: [
  ...
  'string>=': {
    ...
    shortDescription: `Compares the two string arguments lexicographically, and the result is \`true\` if \`string1\` is greater than or equal to \`string2\`, otherwise result is \`false\`.`,
    longDescription: `Compares the two string arguments lexicographically, and the result is \`true\` if \`string1\` is greater than or equal to \`string2\`, otherwise result is \`false\`.`,
    examples: [
      `(string>= "A string" "Another string")`,
      `(string>= "Albert Mojir" "Albert")`,
      `(string>= "Albert" "Albert")`,
  ...
  'string<': {
    ...
    shortDescription: `Compares the two string arguments lexicographically, and the result is \`true\` if \`string1\` is less than \`string2\`, otherwise result is \`false\`.`,
    longDescription: `Compares the two string arguments lexicographically, and the result is \`true\` if \`string1\` is less than \`string2\`, otherwise result is \`false\`.`,
    examples: [
      `(string< "A string" "Another string")`,
      `(string< "Albert Mojir" "Albert")`,
      `(string< "Albert" "Albert")`,
  ...
  'string<=': {
    ...
    shortDescription: `Compares the two string arguments lexicographically, and the result is \`true\` if \`string1\` is less than or equal to \`string2\`, otherwise result is \`false\`.`,
    longDescription: `Compares the two string arguments lexicographically, and the result is \`true\` if \`string1\` is less than or equal to \`string2\`, otherwise result is \`false\`.`,
    examples: [
      `(string<= "A string" "Another string")`,
      `(string<= "Albert Mojir" "Albert")`,
      `(string<= "Albert" "Albert")`,
  ...
  'number-to-string': {
    ...
    shortDescription: `Converts \`number\` to a string. If \`base\` is not equal to \`10\` number must be a non negative integer.`,
    longDescription: `Converts \`number\` to a string. If \`base\` is not equal to \`10\` nu mber must be a non negative integer.`,
    examples: [
      `(number-to-string 10)`,
  ...
  'pad-left': {
    ...
    shortDescription: `Pads from the start of \`string\` with \`padString\` (multiple times, if needed) until the resulting string reaches the given \`length\`.`,
    longDescription: `Pads from the start of \`string\` with \`padString\` (multiple times, if needed) until the resulting string reaches the given \`length\`.`,
    examples: [
      `(pad-left "Albert" 20)`,
      `(pad-left "Albert" 20 "-*-")`,
      `(pad-left "Albert" 5)`,
  ...
  'pad-right': {
    ...
    shortDescription: `Pads at the end of \`string\` with \`padString\` (multiple times, if needed) until the resulting string reaches the given \`length\`.`,
    longDescription: `Pads from the start of \`string\` with \`padString\` (multiple times, if needed) until the resulting string reaches the given \`length\`.`,
    examples: [
      `(pad-right "Albert" 20)`,
      `(pad-right "Albert" 20 "-*-")`,
  ...
  template: {
    ...
    longDescription: `Applies placeholders to a string. Support for basic pluralization - see examples. If pluralization is used, first placeholder must be a number.`,
    examples: [
