module.exports = {
  ...
  pop: {
    ...
    description: `Removes and returns then last item of \`array\`. If \`array\` is empty, \`null\` is returned.`,
  ...
  shift: {
    ...
    description: `Removes and returns the first item of \`array\`. If \`array\` is empty, \`null\` is returned.`,
  ...
  position: {
    ...
    description: `Returns the index of the first elements that pass the test implemented by \`finder\`. If no element was found, \`null\` is returned.`,
    examples: [
  ...
  'index-of': {
    ...
    description: `Returns the index of \`value\` in array. If element is not present in \`array\` \`null\` is returned.`,
    examples: [
  ...
  some: {
    ...
    description: `Returns the first elements that pass the test implemented by \`finder\`. I no element was found, \`null\` is returned.`,
    examples: [
  ...
  first: {
    ...
    description: `Returns the first element of \`array\`. If \`array\` is empty, \`null\` is returned.`,
  ...
  second: {
    ...
    description: `Returns the second element of \`array\`. If \`array\` has less than two elements, \`null\` is returned.`,
  ...
  last: {
    ...
    description: `Returns the last element of \`array\`. If \`array\` is empty, \`null\` is returned.`,
  ...
  next: {
    ...
    description: `If \`input\` is an array, returns a new array with all but the first element from \`input\`. If \`input\` has less than two elements, \`null\` is returned. For string \`input\` returns all but the first characters in \`input\`. If length of string \`input\` is less than two, \`null\` is returned.`,
    examples: [
  ...
  nthnext: {
    ...
    description: `If \`input\` is an array, returns a new array with all but the first \`count\` elements from \`input\`. If \`input\` has less or equal than \`count\` elements, \`null\` returned. For string \`input\` returns all but the first \`count\` characters in \`input\`. If length of string \`input\` is less or equal than \`count\`, \`null\` is returned.`,
    examples: [
