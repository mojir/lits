module.exports = {
  ...
  'when-let': {
    ...
    description: `Binds one local variable. If it evaluates to a truthy value the then-form is executed with the variable accessable. If the bound variable evaluates to false, \`null\` is returned.`,
    examples: [
  ...
  if: {
    ...
    description: `Either \`then\` or \`else\` branch is taken. Then branch is selected when \`test\` result is truthy. I test is falsy and no \`else\` branch exists, \`null\` is returned.`,
    examples: [
  ...
  'if-not': {
    ...
    description: `Either \`then\` or \`else\` branch is taken. Then branch is selected when \`test\` result is falsy. I test is falsy and no \`else\` branch exists, \`null\` is returned.`,
    examples: [
  ...
  cond: {
    ...
    description: `Used for branching. Variants are tested sequentially from the top. I no branch is tested truthy, \`null\` is returned.`,
    examples: [
  ...
  when: {
    ...
    description: `If \`test\` yields a thruthy value, the forms are evaluated in order from left to right and the value returned by the last \`form\` is returned. Otherwise, if \`test\` yields a falsy value, the forms are not evaluated, and \`null\` is returned. If no \`form\` is provided, \`null\` is returned.`,
    examples: [
  ...
  'when-not': {
    ...
    description: `If \`test\` yields a falsy value, the forms are evaluated in order from left to right and the value returned by the last \`form\` is returned. Otherwise, if \`test\` yields a truthy value, the forms are not evaluated, and \`null\` is returned. If no \`form\` is provided, \`null\` is returned.`,
    examples: [
