module.exports = {
  ...
  rand: {
    ...
    shortDescription: `Returns a semi random number between \`0\` (inclusive) and \`number\` (default 1) (exclusive).`,
    longDescription: `Returns a semi random number between \`0\` (inclusive) and \`number\` (default 1) (exclusive).`,
  ...
  'rand-int': {
    ...
    shortDescription: `Returns a semi random integer between \`0\` (inclusive) and \`number\` (exclusive).`,
    longDescription: `Returns a semi random integer between \`0\` (inclusive) and \`number\` (exclusive).`,
