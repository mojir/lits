...
describe('vec:sum', () => {
  ...
  it('should calculate the moving sum of a vector', () => {
    ...
    expect(lits.run('vec:moving-sum([1], 100)')).toEqual([1])
    expect(lits.run('vec:moving-sum([], 1)')).toEqual([])
  })
  it('should calculate the centered moving sum of a vector with padding', () => {
    ...
    expect(lits.run('vec:centered-moving-sum([1, 2, 3, 4, 5, 6], 2)')).toEqual([1, 3, 5, 7, 9, 11])
    expect(lits.run('vec:centered-moving-sum([1, 2, 3, 4, 5, 6], 2, 10)')).toEqual([11, 3, 5, 7, 9, 11])
    expect(lits.run('vec:centered-moving-sum([1, 2, 3, 4, 5, 6], 3)')).toEqual([3, 6, 9, 12, 15, 11])
    expect(lits.run('vec:centered-moving-sum([1, 2, 3, 4, 5, 6], 100)')).toEqual([21, 21, 21, 21, 21, 21])
    expect(lits.run('vec:centered-moving-sum([], 1)')).toEqual([])
  })
