...
describe('geometric', () => {
  it('should return the correct sequence', () => {
    ...
    expect(lits.run('c:geometric-seq(1, 2, 2)')).toEqual([1, 2])
    expect(lits.run('c:geometric-seq(1, 1.5, 4)')).toEqual([1, 1.5, 2.25, 3.375])
  })

  it('should return the correct nth term', () => {
    expect(lits.run('c:geometric-nth(3, 2, 2)')).toEqual(6)
    expect(lits.run('c:geometric-nth(2, 3, 2)')).toEqual(6)
    expect(lits.run('c:geometric-nth(1, 2, 2)')).toEqual(2)
    expect(lits.run('c:geometric-nth(1, 1.5, 4)')).toEqual(3.375)
  })
