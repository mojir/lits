...
const trueNode: AstNode = { t: AstNodeType.ReservedName, v: 'true', debugData: undefined, p: [], n: undefined }
const falseNode: AstNode = { t: AstNodeType.ReservedName, v: 'false', debugData: undefined, p: [], n: undefined }
