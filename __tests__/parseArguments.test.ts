...
describe('parseArguments', () => {
  ...
  describe('defun', () => {
    ...
    test('modifier combinations', () => {
      expect(lispish('((lambda (&optional a &rest b) (list a b)))')).toEqual([undefined, []])
      expect(lispish('((lambda (&optional a &rest b) (list a b)) 1)')).toEqual([1, []])
      expect(lispish('((lambda (&optional a &rest b) (list a b)) 1 2)')).toEqual([1, [2]])
      expect(lispish('((lambda (&optional a &rest b) (list a b)) 1 2 3)')).toEqual([1, [2, 3]])
      expect(lispish('((lambda (a &optional b c &rest d) (list a b c d)) 1)')).toEqual([1, undefined, undefined, []])
      expect(lispish('((lambda (a &optional b c &rest d) (list a b c d)) 1 2)')).toEqual([1, 2, undefined, []])
      expect(lispish('((lambda (a &optional b c &rest d) (list a b c d)) 1 2 3)')).toEqual([1, 2, 3, []])
      expect(lispish('((lambda (a &optional b c &rest d) (list a b c d)) 1 2 3 4)')).toEqual([1, 2, 3, [4]])
      expect(lispish('((lambda (a &optional b c &rest d) (list a b c d)) 1 2 3 4 5)')).toEqual([1, 2, 3, [4, 5]])
