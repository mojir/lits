...
describe('specialExpressions', () => {
  ...
  describe('def', () => {
    it('samples', () => {
      ...
      expect(() => lits.run('(def null 10)')).toThrow()
  ...
  describe('if', () => {
    it('samples', () => {
      ...
      expect(lits.run('(if null :A :B)')).toBe('B')
  ...
  describe('unless', () => {
    it('samples', () => {
      ...
      expect(lits.run('(unless null :A :B)')).toBe('A')
  ...
  describe('defn', () => {
    it('samples', () => {
      ...
      expect(() => lits.run('(defn null [] 10)')).toThrow()
  ...
  describe('fn', () => {
    it('samples', () => {
      ...
      expect(() => lits.run('(fn (null) 1)')).toThrow()
