    ...
    describe(`when-let`, () => {
      ...
      describe(`undefinedSymbols`, () => {
        test(`samples`, () => {
          ...
          expect(getUndefinedSymbolNames(lits.analyze(`(when-let [name (str name :_)] name)`))).toEqual(
            new Set([`name`]),
          )
        })
      })
    ...
    describe(`defns`, () => {
      ...
      describe(`undefinedSymbols`, () => {
        test(`samples`, () => {
          ...
          expect(getUndefinedSymbolNames(lits.analyze(`(defns :add ([a b & rest] (+ a b)) ([a] 10))`))).toEqual(
            new Set(),
          )
        })
      })
