...
describe('sequence functions', () => {
  describe('nth', () => {
    it('array samples', () => {
      for (const lits2 of litsInstances) {
        ...
        expect(() => lits2.run('nth({}, 1)')).toThrow()
  ...
  describe('last-index-of', () => {
    it('samples', () => {
      ...
      expect(() => lits.run('last-index-of(+)')).toThrow()
      expect(() => lits.run('last-index-of()')).toThrow()
    })
  })
  ...
  describe('push', () => {
    it('samples', () => {
      ...
      expect(() => lits.run('push({}, "2")')).toThrow()
  ...
  describe('unshift', () => {
    it('samples', () => {
      ...
      expect(() => lits.run('unshift({}, "2")')).toThrow()
  ...
  describe('take-last', () => {
    it('samples', () => {
      ...
      expect(() => lits.run('take-last(null)')).toThrow()
  ...
  describe('take-while', () => {
    it('samples', () => {
      ...
      expect(() => lits.run('take-while({}, -> $ < 3))')).toThrow()
      expect(() => lits.run('take-while(null, -> $ < 3)')).toThrow()
      expect(() => lits.run('take-while(true, -> $ < 3)')).toThrow()
      expect(() => lits.run('take-while(false, -> $ < 3)')).toThrow()
      expect(() => lits.run('take-while([1, 2, 3], 10)')).toThrow()
      expect(() => lits.run('take-while()')).toThrow()
      expect(() => lits.run('take-while([1, 2, 3])')).toThrow()
      expect(() => lits.run('take-while([1, 2, 3], -> $ < 3 1)')).toThrow()
    })
    it('new array created', () => {
      const program = `
        let l1 := [1, 2, 3];
  ...
  describe('drop-last', () => {
    it('samples', () => {
      ...
      expect(() => lits.run('drop-last(null, 1)')).toThrow()
  ...
  describe('drop-while', () => {
    it('samples', () => {
      ...
      expect(() => lits.run('drop-while({}, -> $ < 3))')).toThrow()
      expect(() => lits.run('drop-while(null, -> $ < 3)')).toThrow()
      expect(() => lits.run('drop-while(true, -> $ < 3)')).toThrow()
      expect(() => lits.run('drop-while(false, -> $ < 3)')).toThrow()
      expect(() => lits.run('drop-while([1, 2, 3], 10)')).toThrow()
      expect(() => lits.run('drop-while()')).toThrow()
      expect(() => lits.run('drop-while([1, 2, 3])')).toThrow()
      expect(() => lits.run('drop-while([1, 2, 3], -> $ < 3 1)')).toThrow()
    })
    it('new array created', () => {
      const program = `
        let l1 := [1, 2, 3];
  ...
  describe('sort', () => {
    it('samples', () => {
      ...
      expect(() => lits.run('sort(10, (a, b) -> cond case a > b then -1 case a < b then 1 case true then -1 end)')).toThrow()
      expect(() => lits.run('sort((a, b) -> cond case a > b then -1 case a < b then 1 case true then -1 end)')).toThrow()
  ...
  describe('remove-at', () => {
    it('samples', () => {
      ...
      expect(() => lits.run('remove-at("Albert", 1, 2')).toThrow()
    })
  })
  ...
  describe('split-with', () => {
    it('samples', () => {
      ...
      expect(() => lits.run('split-with("Albert", -> $1 <= "Z", "Mojir")')).toThrow()
    })
  })
  ...
  describe('partition', () => {
    it('samples', () => {
      ...
      expect(() => lits.run('partition1)')).toThrow()
  ...
  describe('starts-with?', () => {
    it('samples', () => {
      ...
      expect(() => lits.run('starts-with?("Albert", "foo", 2)')).toThrow()
      expect(() => lits.run('starts-with?("Albert")')).toThrow()
      expect(() => lits.run('starts-with?(')).toThrow()
    })
  })
  ...
  describe('ends-with?', () => {
    it('samples', () => {
      ...
      expect(() => lits.run('ends-with?("Albert", "foo", 2)')).toThrow()
      expect(() => lits.run('ends-with?("Albert")')).toThrow()
      expect(() => lits.run('ends-with?()')).toThrow()
    })
  })
  describe('interleave', () => {
    it('samples', () => {
