...
describe(`predicates`, () => {
  describe(`function?`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`(function? (function +))`)).toBe(true)
  ...
  describe(`string?`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`(string? +)`)).toBe(false)
      expect(lispish.run(`(string? (function +))`)).toBe(false)
  ...
  describe(`number?`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`(number? +)`)).toBe(false)
      expect(lispish.run(`(number? (function +))`)).toBe(false)
  ...
  describe(`integer?`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`(integer? +)`)).toBe(false)
      expect(lispish.run(`(integer? (function +))`)).toBe(false)
  ...
  describe(`boolean?`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`(boolean? +)`)).toBe(false)
      expect(lispish.run(`(boolean? (function +))`)).toBe(false)
  ...
  describe(`undefined?`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`(undefined? +)`)).toBe(false)
      expect(lispish.run(`(undefined? (function +))`)).toBe(false)
  ...
  describe(`null?`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`(null? +)`)).toBe(false)
      expect(lispish.run(`(null? (function +))`)).toBe(false)
  ...
  describe(`list?`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`(list? -1)`)).toBe(false)
      expect(lispish.run(`(list? -1.123)`)).toBe(false)
      expect(lispish.run(`(list? 0.123)`)).toBe(false)
      expect(lispish.run(`(list? "")`)).toBe(false)
      expect(lispish.run(`(list? "x")`)).toBe(false)
      expect(lispish.run(`(list? [])`)).toBe(true)
      expect(lispish.run(`(list? (object))`)).toBe(false)
      expect(lispish.run(`(list? null)`)).toBe(false)
      expect(lispish.run(`(list? false)`)).toBe(false)
      expect(lispish.run(`(list? true)`)).toBe(false)
      expect(lispish.run(`(list? undefined)`)).toBe(false)
      expect(lispish.run(`(list? +)`)).toBe(false)
      expect(lispish.run(`(list? (function +))`)).toBe(false)
      expect(() => lispish.run(`(list?)`)).toThrow()
      expect(() => lispish.run(`(list? true false)`)).toThrow()
    })
  })
  ...
  describe(`object?`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`(object? +)`)).toBe(false)
      expect(lispish.run(`(object? (function +))`)).toBe(false)
  ...
  describe(`regexp?`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`(regexp? +)`)).toBe(false)
      expect(lispish.run(`(regexp? (function +))`)).toBe(false)
