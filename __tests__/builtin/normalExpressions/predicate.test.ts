...
describe(`predicates`, () => {
  ...
  describe(`coll?`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`(coll? null)`)).toBe(false)
      expect(lispish.run(`(coll? false)`)).toBe(false)
      expect(lispish.run(`(coll? true)`)).toBe(false)
      expect(lispish.run(`(coll? undefined)`)).toBe(false)
  ...
  describe(`seq?`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`(seq? null)`)).toBe(false)
      expect(lispish.run(`(seq? false)`)).toBe(false)
      expect(lispish.run(`(seq? true)`)).toBe(false)
      expect(lispish.run(`(seq? undefined)`)).toBe(false)
