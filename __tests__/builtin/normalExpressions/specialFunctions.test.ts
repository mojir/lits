...
describe(`specialFunctions`, () => {
  describe(`string as function`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`("x" {"firstName" "Albert", "lastName", "Mojir"})`)).toBeNull()
      expect(lispish.run(`("Albert" 2)`)).toBe(`b`)
      expect(lispish.run(`("Albert" 12)`)).toBeNull()
      ...
      expect(() => lispish.run(`(nil {"firstName" "Albert", "lastName", "Mojir"})`)).toThrow()
  ...
  describe(`object as function`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`({"firstName" "Albert", "lastName", "Mojir"} "x")`)).toBeNull()
      expect(() => lispish.run(`({"firstName" "Albert", "lastName", "Mojir"})`)).toThrow()
      expect(() => lispish.run(`({"firstName" "Albert", "lastName", "Mojir"} 1)`)).toThrow()
      expect(() => lispish.run(`({"firstName" "Albert", "lastName", "Mojir"} nil)`)).toThrow()
  ...
  describe(`array as function`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`("Albert" 10)`)).toBeNull()
  ...
  describe(`number as function`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`(3 ["Albert" "Mojir"])`)).toBeNull()
      expect(lispish.run(`(1 (cons 1 [2 3]))`)).toBe(2)
      expect(lispish.run(`(1 "Albert")`)).toBe(`l`)
      expect(lispish.run(`(10 "Albert")`)).toBeNull()
      expect(() => lispish.run(`(["Albert" "Mojir"])`)).toThrow()
