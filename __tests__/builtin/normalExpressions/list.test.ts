...
describe('list functions', () => {
  describe('list', () => {
    test('samples', () => {
      ...
      expect(lispish(`(list 0 "1" null true false undefined (list '()) (object))`)).toEqual([
        0,
        '1',
        null,
        true,
    ...
    test('shorthand samples', () => {
      ...
      expect((lispish(`'(undefined)`) as unknown[])[0]).toEqual(undefined)
      expect(lispish(`'(0 "1" null true false undefined '('()) (object))`)).toEqual([
        0,
        '1',
        null,
        true,
  ...
  describe('lenght', () => {
    test('samples', () => {
      ...
      expect(lispish(`(length '(1 2 3))`)).toBe(3)
  ...
  describe('append', () => {
    test('samples', () => {
      ...
      expect(lispish(`(append '(1))`)).toEqual([1])
      expect(lispish(`(append '(1) '(2) '(3 4))`)).toEqual([1, 2, 3, 4])
      expect(lispish(`(append '(1 2 3) '())`)).toEqual([1, 2, 3])
      expect(() => lispish(`(append)`)).toThrow()
      expect(() => lispish(`(append '(1) "2")`)).toThrow()
  ...
  describe('slice', () => {
    test('samples', () => {
      expect(lispish(`(slice '(1 2 3))`)).toEqual([1, 2, 3])
      expect(lispish(`(slice '(1 2 3) 0)`)).toEqual([1, 2, 3])
      expect(lispish(`(slice '(1 2 3) 1)`)).toEqual([2, 3])
      expect(lispish(`(slice '(1 2 3) -1)`)).toEqual([3])
      expect(lispish(`(slice '(1 2 3) -3)`)).toEqual([1, 2, 3])
      expect(lispish(`(slice '(1 2 3) -4)`)).toEqual([1, 2, 3])
      expect(lispish(`(slice '(1 2 3) 3)`)).toEqual([])
      expect(lispish(`(slice '(1 2 3) 4)`)).toEqual([])
      expect(lispish(`(slice '(1 2 3) 0 0)`)).toEqual([])
      expect(lispish(`(slice '(1 2 3) 0 1)`)).toEqual([1])
      expect(lispish(`(slice '(1 2 3) 0 10)`)).toEqual([1, 2, 3])
      expect(lispish(`(slice '(1 2 3) 0 -1)`)).toEqual([1, 2])

      expect(() => lispish(`(slice '(1 2 3) 1 2 3)`)).toThrow()
  ...
  describe('splice', () => {
    test('samples', () => {
      expect(lispish(`(setq l '(1 2 3)) (splice l 0)`)).toEqual([1, 2, 3])
      expect(lispish(`(setq l '(1 2 3)) (splice l 0) l`)).toEqual([])
      expect(lispish(`(setq l '(1 2 3)) (splice l 1)`)).toEqual([2, 3])
      expect(lispish(`(setq l '(1 2 3)) (splice l 1) l`)).toEqual([1])
      expect(lispish(`(setq l '(1 2 3)) (splice l 1 0)`)).toEqual([])
      expect(lispish(`(setq l '(1 2 3)) (splice l 1 0) l`)).toEqual([1, 2, 3])
      expect(lispish(`(setq l '(1 2 3)) (splice l 1 1)`)).toEqual([2])
      expect(lispish(`(setq l '(1 2 3)) (splice l 1 1) l`)).toEqual([1, 3])
      expect(lispish(`(setq l '(1 2 3)) (splice l 1 2)`)).toEqual([2, 3])
      expect(lispish(`(setq l '(1 2 3)) (splice l 1 2) l`)).toEqual([1])
      expect(lispish(`(setq l '(1 2 3)) (splice l 1 100)`)).toEqual([2, 3])
      expect(lispish(`(setq l '(1 2 3)) (splice l 1 100) l`)).toEqual([1])
      expect(lispish(`(setq l '(1 2 3)) (splice l 1 1 "x")`)).toEqual([2])
      expect(lispish(`(setq l '(1 2 3)) (splice l 1 1 "x") l`)).toEqual([1, 'x', 3])
      expect(lispish(`(setq l '(1 2 3)) (splice l 1 0 "x")`)).toEqual([])
      expect(lispish(`(setq l '(1 2 3)) (splice l 1 0 "x") l`)).toEqual([1, 'x', 2, 3])
      expect(lispish(`(setq l '(1 2 3)) (splice l 100 0 "x")`)).toEqual([])
      expect(lispish(`(setq l '(1 2 3)) (splice l 100 0 "x") l`)).toEqual([1, 2, 3, 'x'])
      expect(lispish(`(setq l '(1 2 3)) (splice l -1 0 "x")`)).toEqual([])
      expect(lispish(`(setq l '(1 2 3)) (splice l -1 0 "x") l`)).toEqual([1, 2, 'x', 3])
      expect(lispish(`(setq l '(1 2 3)) (splice l -100 0 "x")`)).toEqual([])
      expect(lispish(`(setq l '(1 2 3)) (splice l -100 0 "x") l`)).toEqual(['x', 1, 2, 3])
      expect(lispish(`(setq l '(1 2 3)) (splice l 1 1 "x" "y" "z")`)).toEqual([2])
      expect(lispish(`(setq l '(1 2 3)) (splice l 1 1 "x" "y" "z") l`)).toEqual([1, 'x', 'y', 'z', 3])
      expect(() => lispish(`(splice '(1 2 3))`)).toThrow()
      expect(() => lispish(`(splice))`)).toThrow()
      expect(() => lispish(`(splice '(1 2 3) "1")`)).toThrow()
      expect(() => lispish(`(splice '(1 2 3) 1 "2")`)).toThrow()
  ...
  describe('reduce', () => {
    test('samples', () => {
      ...
      expect(lispish(`(reduce (function +) '(1 2 3) 0)`)).toBe(6)
      expect(lispish(`(reduce (function +) '() 0)`)).toBe(0)
      expect(lispish(`(reduce (function +) '() 1)`)).toBe(1)
      expect(() => lispish(`(reduce (function +) '(1 2 3))`)).toThrow()
  ...
  describe('reduce-right', () => {
    test('samples', () => {
      expect(lispish(`(reduce-right (function +) '(1 2 3) 0)`)).toBe(6)
      expect(lispish(`(reduce-right (function +) '() 0)`)).toBe(0)
      expect(lispish(`(reduce-right (function +) '() 1)`)).toBe(1)
      expect(lispish(`(reduce-right (function concat) '("1" "2" "3") "")`)).toBe('321')
  ...
  describe('filter', () => {
    test('samples', () => {
      expect(lispish(`(filter (function number?) '(1 "2" 3))`)).toEqual([1, 3])
      expect(lispish(`(filter (function number?) '())`)).toEqual([])
      expect(lispish(`(filter (function null?) '(1 "2" 3))`)).toEqual([])
      expect(lispish(`(filter (lambda (x) (zero? (% x 3))) '(0 1 2 3 4 5 6 7))`)).toEqual([0, 3, 6])
      expect(() => lispish(`(filter (function +))`)).toThrow()
      expect(() => lispish(`(filter)`)).toThrow()
      expect(() => lispish(`(filter (function number?) '(1) 2)`)).toThrow()
    })
  })

  describe('find', () => {
    test('samples', () => {
      expect(lispish(`(find (function number?) '("1" "2" 3))`)).toEqual(3)
      expect(lispish(`(find (function number?) '("1" "2" "3"))`)).toBeUndefined()
      expect(lispish(`(find (function number?) '())`)).toBeUndefined()
      expect(lispish(`(find (lambda (x) (zero? (% x 3))) '(1 2 3 4 5 6 7))`)).toEqual(3)
      expect(() => lispish(`(find (function +))`)).toThrow()
      expect(() => lispish(`(find)`)).toThrow()
      expect(() => lispish(`(find (function number?) '(1) 2)`)).toThrow()
    })
  })

  describe('position', () => {
    test('samples', () => {
      expect(lispish(`(position (function number?) '("1" "2" 3))`)).toEqual(2)
      expect(lispish(`(position (function number?) '("1" "2" "3"))`)).toBeUndefined()
      expect(lispish(`(position (function number?) '())`)).toBeUndefined()
      expect(lispish(`(position (lambda (x) (zero? (% x 3))) '(1 2 3 4 5 6 7))`)).toEqual(2)
      expect(() => lispish(`(position (function +))`)).toThrow()
      expect(() => lispish(`(position)`)).toThrow()
      expect(() => lispish(`(position (function number?) '(1) 2)`)).toThrow()
    })
  })

  describe('some', () => {
    test('samples', () => {
      expect(lispish(`(some (function number?) '("1" "2" 3))`)).toBe(true)
      expect(lispish(`(some (function number?) '("1" "2" "3"))`)).toBe(false)
      expect(lispish(`(some (function number?) '())`)).toBe(false)
      expect(lispish(`(some (lambda (x) (zero? (% x 3))) '(1 2 3 4 5 6 7))`)).toBe(true)
      expect(() => lispish(`(some (function +))`)).toThrow()
      expect(() => lispish(`(some)`)).toThrow()
      expect(() => lispish(`(some (function number?) '(1) 2)`)).toThrow()
    })
  })

  describe('every', () => {
    test('samples', () => {
      expect(lispish(`(every (function number?) '(1 2 3))`)).toBe(true)
      expect(lispish(`(every (function number?) '("1" "2" "3"))`)).toBe(false)
      expect(lispish(`(every (function number?) '())`)).toBe(false)
      expect(lispish(`(every (lambda (x) (zero? (% x 2))) '(2 4 6))`)).toBe(true)
      expect(() => lispish(`(every (function +))`)).toThrow()
      expect(() => lispish(`(every)`)).toThrow()
      expect(() => lispish(`(every (function number?) '(1) 2)`)).toThrow()
    })
  })
  ...
  describe('first', () => {
    test('samples', () => {
      expect(lispish(`(first '(1 2 3))`)).toEqual(1)
      expect(lispish(`(first '("1"))`)).toEqual('1')
      expect(lispish(`(first '())`)).toBeUndefined()
  ...
  describe('second', () => {
    test('samples', () => {
      expect(lispish(`(second '(1 2 3))`)).toEqual(2)
      expect(lispish(`(second '("1"))`)).toBeUndefined()
      expect(lispish(`(second '())`)).toBeUndefined()
  ...
  describe('reverse', () => {
    test('samples', () => {
      expect(lispish(`(reverse '(1 2 3))`)).toEqual([3, 2, 1])
      expect(lispish(`(reverse '("1"))`)).toEqual(['1'])
      expect(lispish(`(reverse '())`)).toEqual([])
  ...
  describe('last', () => {
    test('samples', () => {
      expect(lispish(`(last '(1 2 3))`)).toEqual(3)
      expect(lispish(`(last '("1"))`)).toEqual('1')
      expect(lispish(`(last '())`)).toBeUndefined()
  ...
  describe('rest', () => {
    test('samples', () => {
      expect(lispish(`(rest '(1 2 3))`)).toEqual([2, 3])
      expect(lispish(`(rest '(1 2))`)).toEqual([2])
      expect(lispish(`(rest '("1"))`)).toEqual(undefined)
      expect(lispish(`(rest '())`)).toEqual(undefined)
  ...
  describe('cons', () => {
    test('samples', () => {
      expect(lispish(`(cons 0 '(1 2 3))`)).toEqual([0, 1, 2, 3])
      expect(lispish(`(cons 0 '("1"))`)).toEqual([0, '1'])
      expect(lispish(`(cons 0 '())`)).toEqual([0])
  ...
  describe('selt', () => {
    test('samples', () => {
      expect(lispish(`(selt '(1 2 3) 0 "1")`)).toEqual(['1', 2, 3])
      expect(lispish(`(selt '(1 2 3) 1 "2")`)).toEqual([1, '2', 3])

      expect(() => lispish(`(selt '(1 2 3) 3 "4")`)).toThrow()
      ...
      expect(() => lispish(`(selt "1" 0 "2")`)).toThrow()
      expect(() => lispish(`(selt '(1) "0" "2")`)).toThrow()
      expect(() => lispish(`(selt '(1) true "2")`)).toThrow()
      expect(() => lispish(`(selt '(1) false "2")`)).toThrow()
      expect(() => lispish(`(selt '(1) '() "2")`)).toThrow()
      expect(() => lispish(`(selt '(1) null "2")`)).toThrow()
      expect(() => lispish(`(selt '(1) undefined "2")`)).toThrow()
      expect(() => lispish(`(selt 0 "2")`)).toThrow()
      expect(() => lispish(`(selt '(1 2 3) -1 "x")`)).toThrow()
      expect(() => lispish(`(selt '(1 2 3) 4 "x")`)).toThrow()
      expect(() => lispish(`(selt)`)).toThrow()
      expect(() => lispish(`(selt '())`)).toThrow()
      expect(() => lispish(`(selt '() 0)`)).toThrow()
      expect(() => lispish(`(selt '() 0 "x" "y")`)).toThrow()
    })
  })

  describe('push', () => {
    test('samples', () => {
      expect(lispish(`(push '(1 2 3) 0)`)).toEqual([1, 2, 3, 0])
      expect(lispish(`(push '(1 2 3) 1 "2")`)).toEqual([1, 2, 3, 1, '2'])
      expect(lispish(`(setq l '(1 2 3)) (push l 1 "2") l`)).toEqual([1, 2, 3, 1, '2'])

      expect(() => lispish(`(push '(1 2 3))`)).toThrow()
  ...
  describe('pop', () => {
    test('samples', () => {
      expect(lispish(`(pop '(1 2 3))`)).toBe(3)
      expect(lispish(`(pop '(1 2 undefined))`)).toBeUndefined()
      expect(lispish(`(pop '())`)).toBeUndefined()
      expect(lispish(`(setq l '(1 2 3)) (pop l) l`)).toEqual([1, 2])
      expect(lispish(`(setq l '()) (pop l) l`)).toEqual([])
  ...
  describe('unshift', () => {
    test('samples', () => {
      expect(lispish(`(unshift '(1 2 3) 0)`)).toEqual([0, 1, 2, 3])
      expect(lispish(`(unshift '(1 2 3) 1 "2")`)).toEqual([1, '2', 1, 2, 3])
      expect(lispish(`(setq l '(1 2 3)) (unshift l 1 "2") l`)).toEqual([1, '2', 1, 2, 3])

      expect(() => lispish(`(unshift '(1 2 3))`)).toThrow()
  ...
  describe('shift', () => {
    test('samples', () => {
      expect(lispish(`(shift '(1 2 3))`)).toBe(1)
      expect(lispish(`(shift '(undefined 2 3))`)).toBeUndefined()
      expect(lispish(`(shift '())`)).toBeUndefined()
      expect(lispish(`(setq l '(1 2 3)) (shift l) l`)).toEqual([2, 3])
      expect(lispish(`(setq l '()) (shift l) l`)).toEqual([])
  ...
  describe('take', () => {
    test('samples', () => {
      expect(lispish(`(take '(1 2 3) 2)`)).toEqual([1, 2])
      expect(lispish(`(take '(1 2 3) 20)`)).toEqual([1, 2, 3])
      expect(lispish(`(take '(1 2 3) 0)`)).toEqual([])

      expect(() => lispish(`(take '(1 2 3) 0.5)`)).toThrow()
      ...
      expect(() => lispish(`(take '(1 2 3))`)).toThrow()
      expect(() => lispish(`(take '(1 2 3) 1 2)`)).toThrow()
    })
  ...
  describe('take-while', () => {
    test('samples', () => {
      expect(lispish(`(take-while (lambda (x) (< x 3)) '(1 2 3 2 1))`)).toEqual([1, 2])
      expect(lispish(`(take-while (lambda (x) (> x 3)) '(1 2 3 2 1))`)).toEqual([])
      ...
      expect(() => lispish(`(take-while 10 '(1 2 3))`)).toThrow()
      expect(() => lispish(`(take-while)`)).toThrow()
      expect(() => lispish(`(take-while '(1 2 3))`)).toThrow()
      expect(() => lispish(`(take-while (lambda (x) (< x 3)) '(1 2 3) 1)`)).toThrow()
    })
    test('new list created', () => {
      const program = `
        (setq l1 '(1 2 3))
  ...
  describe('sort', () => {
    test('samples', () => {
      expect(lispish(`(sort (lambda (a b) (cond ((< a b) -1) ((> a b) 1) (true -1))) '(3 1 2))`)).toEqual([1, 2, 3])
      expect(lispish(`(sort (lambda (a b) (cond ((> a b) -1) ((< a b) 1) (true -1))) '(3 1 2))`)).toEqual([3, 2, 1])
      expect(lispish(`(sort (lambda (a b) (cond ((> a b) -1) ((< a b) 1) (true -1))) '())`)).toEqual([])
      ...
      expect(() => lispish(`(sort '(10))`)).toThrow()
