...
describe(`math functions`, () => {
  ...
  describe(`sqrt`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`(sqrt -3)`)).toBeNaN()
  ...
  describe(`log`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`(log -2)`)).toBeNaN()
      expect(lispish.run(`(log 0)`)).toBe(Number.NEGATIVE_INFINITY)
      expect(lispish.run(`(log -0)`)).toBe(Number.NEGATIVE_INFINITY)
  ...
  describe(`log2`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`(log2 -2)`)).toBeNaN()
      expect(lispish.run(`(log2 0)`)).toBe(Number.NEGATIVE_INFINITY)
      expect(lispish.run(`(log2 -0)`)).toBe(Number.NEGATIVE_INFINITY)
  ...
  describe(`log10`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`(log10 -2)`)).toBeNaN()
      expect(lispish.run(`(log10 0)`)).toBe(Number.NEGATIVE_INFINITY)
      expect(lispish.run(`(log10 -0)`)).toBe(Number.NEGATIVE_INFINITY)
  ...
  describe(`asin`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`(asin 100)`)).toBeNaN()
  ...
  describe(`acos`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`(acos 100)`)).toBeNaN()
  ...
  describe(`acosh`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`(acosh 0.1)`)).toBeNaN()
      expect(lispish.run(`(acosh -0.1)`)).toBeNaN()
      expect(lispish.run(`(acosh 0)`)).toBeNaN()
  ...
  describe(`atanh`, () => {
    test(`samples`, () => {
      ...
      expect(lispish.run(`(atanh -0.1)`)).toBe(Math.atanh(-0.1))
      expect(lispish.run(`(atanh 1)`)).toBe(Number.POSITIVE_INFINITY)
